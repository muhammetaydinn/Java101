...
public class PratikHesapMak {
    public PratikHesapMak(){
    ...
    static void modAlma() {
        Scanner scan = new Scanner(System.in);
        System.out.println("Modunu alacaginiz sayiyi giriniz :");
        int n = scan.nextInt();
        System.out.println("Kaca gore modunu almak istediginizi giriniz :");
        int m = scan.nextInt();
